...
def usr(robot):
    ...
    while True:
        ...
        try:
            ...
            log.write('Separation/cohesion/alignment error\n')
            log.flush()
        ...
        try:
            log.write('Heading = ', pose2[2], ', Desired Heading = ', heading, ' for Robot ', robot.id, '\n')
            log.flush()
